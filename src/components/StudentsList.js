...
const StudentsList = (props) => {
  let students = props.students.filter(
    (students) => students.course === props.selectedCourse.name
  )
  let studentCards = students.map((student) => (
    <Student key={student.id} student={student} checkBoxHandler={props.checkBoxHandler} />
  ))
